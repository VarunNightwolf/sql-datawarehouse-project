...
create table silver.crm_prd_info (prd_id int,cat_id varchar(55), prd_key nvarchar(55),	prd_nm nvarchar(55), prd_cost int,	prd_line nvarchar(55),	prd_start_dt date,
prd_end_dt date, dwh_create_date datetime2 default getdate());

if object_id('silver.crm_sales_details','U') IS NOT NULL DROP TABLE silver.crm_sales_details;
create table silver.crm_sales_details (sls_ord_num nvarchar(55),sls_prd_key	nvarchar(55), sls_cust_id int,	sls_order_dt date,	sls_ship_dt date,
